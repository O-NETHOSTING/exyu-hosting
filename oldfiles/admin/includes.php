...
function srvgrafik($ip, $port) {
	...
	$grafik = '<span class="autor" data-selector="true" data-content="<img src=\'https://your-hosting.com/grafik/'.$ipport.'.png\' />" style="color: #95A1AB">' . $ip . ':<m>' . $port . '</m></span>';
...
function admin_avatar($id) {
	...
	$avatar = '/admin/avatar.php?mode=a&id=' . $id;
	
	if($query['avatar'] == "no_avatar.png") $av = "no_avatar.png";
	else $av = $id . $query['avatar'];

	return "https://your-hosting.com/admin/avatari/{$av}";	
}

function user_avatar($id) {
	//$avatar = '/admin/avatar.php?mode=c&id=' . $id;
	...
	return "https://your-hosting.com/avatari/{$query[avatar]}";	
}
