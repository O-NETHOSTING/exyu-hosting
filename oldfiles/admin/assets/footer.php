		...
		<div class="container">
			...
			<div class="row">
				...
				<div id="footer-copyright" class="span6">
					2018 &copy; <m>YOUR HOSTING</m>
				</div> <!-- /span6 -->
				
				<div id="footer-terms" class="span6">
					<i class="icon-html5 icon-2x"></i><span style="margin-left: 10px;"> Power by www.your-hosting.com</span>
				</div> <!-- /.span6 -->
...
?>
			<div class="control-group">
				...
				<select class="span5" name="pernament" id="trajni_ban">
					...
					<option value="2" disabled>Trajni ban</option>
				</select>
			</div>	
	...
	<div class="modal-body">
		<form action="process.php" method="post" id="validation-form" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input name="datacentar" class="span5" type="text" placeholder="Datacentar">
				</div>
			</div>	
	...
	<div class="modal-body">
		<form action="process.php" method="post" id="validation-form" enctype="multipart/form-data">
			...
			<div class="control-group">
				<label for="ssh2port">SSH2 Port</label>
				<div class="controls">
					<input name="ssh2port" class="span5" type="text" value="<?php echo $box['sshport']; ?>">
...
<div id="edit_smszemlju" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="label" aria-hidden="true">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h3 id="label">Edit slajd</h3>
	</div>
	<div class="modal-body">
		<form action="process.php" method="post" enctype="multipart/form-data">
			<input type="hidden" name="task" value="edit_slajd" />
			<input type="hidden" class="id_sms" name="id" value="" />
			
			<div class="control-group">
				<label for="naslov">Poruka</label>
				<div class="controls">
					<input id="naslovs" name="poruka" class="span5" type="text" value="">
				</div>
			</div>
			
			<div class="control-group">
				<label for="tekst">Broj</label>
				<div class="controls">
					<textarea id="texts" name="broj" class="span5" type="text" value=""></textarea>
				</div>
			</div>
			
			<div class="control-group">
				<label for="naslov">Cijena</label>
				<div class="controls">
					<input id="slikas" name="cijena" class="span5" type="text" value="">
				</div>
			</div>
			
			<div class="control-group">
				<label for="naslov">Status</label>
				<div class="controls">
					<input id="slikas" name="status" class="span5" type="text" value="">
				</div>
			</div>
	</div>
			<div class="modal-footer">
	...
	<div class="modal-body">
		<form action="process.php" method="post" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input name="ime" class="span5" type="text" placeholder="Ime moda">
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<select name="igra">
						...
						<option value="5">Multi Theft Auto</option>
					</select>	
				</div>
			</div>		
			...
			<div class="control-group">
				<label for="text">Cena po slotu</label>
				<div class="controls">
...
<div id="modedit" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="label" aria-hidden="true">
	...
	<script src="assets/blue/js/autosize.js"></script>
	...
	<script src="assets/blue/js/form.js"></script>
	
	<script src="assets/js/etrail.js"></script>
