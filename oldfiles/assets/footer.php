					...
					<table style="width: 100%; vertical-align: top; border-spacing: 0px;">
						...
						<tr>
							...
							<td>
								...
								<div>
									<div class="fb-like-box" data-href="https://www.facebook.com/ex" data-width="230" data-height="40" data-colorscheme="dark" data-show-faces="true" data-header="false" data-stream="false" data-show-border="false"></div>
								</div>
							</td>
							<td style="border-right: none">
								...
								<div id="footerlinks" class="test2">
									<ul>
										<li style="margin-left: -5px;"><div id="footerik2"></div><a href="mailto:info@your-hosting.com">Email</a></li>
										<li style="margin-left: -5px;"><div id="footerik3"></div><a href="https://www.facebook.com/YOURh">Facebook </a></li>
...
?>					
					<div id="copy">
						<p>
						<span style="float: left; text-align: left; width: 70%;">© YOUR HOSTING SOLUTION All rights reserved. / Designed and coded by <a href="#">Filip Veličković</a>. </span> <span style="float: left; width: 29%; text-align: right;">Stranica učitana za: <a><?php echo $pageload; ?>s</a> | Verzija: <?php echo $verzija['value']; ?></a></span>
						</p>
					</div>
				</div>   	
		</footer>
		...
		<form class="modal-uplata" id="modal-uplata">
			...
			<div style="padding: 7px;" id="hpromeni">
					...
					<table width="100%">
						<tr style="vertical-align: top;">
							<td>
								...
								Svrha uplate: <z>YOUR Hosting</z><br />
								Primalac: <z>YOUR HOSTING</z><br />
							</td>
							<td>
								Iznos: <z>Bilo koj iznos u dinarima</z><br />
								Račun primaoca: <z>YOUR TRN</z><br />
							</td>
						</tr>
					</table>	
				...
				<div id="narcg" style="display: none;">
					...
					* Kliknite na sliku za veci primerak.<br /><br />
					<z>UPUSTVA:</z><br />
					Da bi zakupili server prvo morate imati novca na YOUR računu. <br />To radite tako što uplatite sumu koju želite ( prvo pogledati cene servera kojeg hoćete uplatiti pa onda uplatite toliko novca, a možete i više ). Kada uplatite u pošti ili banci, slikajte uplatnicu sa pečatom koju ćete dobiti nakon uplate ( pečat i popunjene podatke moraju da se vide dobro ) prebaciti na kompjuter i uploadujte na nekom image upload sajtu. <br />Nakon toga možete nastaviti ove korake i čim administracija prihvati vašu uplatu, novac se prebacuje na vašem nalogu i vi možete zakupiti server.
					...
					<table width="100%">
						<tr style="vertical-align: top;">
							<td>
								...
								Primatelj: <z>YOUR HOSTING<br />
							</td>
							<td>
								Iznos: <z>Bilo koj iznos u kunama</z><br />
								Broj računa: <z>YOUR TRN</z><br />
