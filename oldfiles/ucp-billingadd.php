...
<?php	} else if($_GET['tip']=="banka") {	?>
            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        ...
                        <input type="hidden" name="item_name" value="your-hosting.com.info Payment Add Funds">
                        ...
                        <?php
                            ...
                            echo '<input type="hidden" name="notify_url" value="https://your-hosting.com/paypal/paypal_payment.php" />';
                            else
                            echo '<input type="hidden" name="notify_url" value="https://your-hosting.com/paypal/paypal_payment.php" />';


                        ?>
                        <input type="hidden" name="cancel_return" value="https://your-hosting.com/ucp-billingadd.php?tip=paypalcancel" />
                        <input type="hidden" name="return" value="https://your-hosting.com/ucp-billingadd.php?tip=paypalsuccessfunds" />

                        <input type="hidden" name="cbt" value="Back to YOUR Hosting" />
                        <input type="hidden" name="no_note" value="1" />
                        <input type="hidden" name="no_shipping" value="1" />
                        <input type="hidden" name="cs" value="1" />
                        <input type="hidden" name="cpp_header_image" value="https://your-hosting.com/assets/blue/img/logo2.png" />
                        ...
                        <input type="text" name="amount" class="input" id="ki" placeholder="<?php echo $jezik['text576']; ?>: 10€"/> <br />
    ...
    ?>
        <div id="infox">
            ...
            <p id="h5">SMS plaćanje</p><br />
            <p>Izaberite i popunite sva polja, zatim pratite dalja upustva koja će uslediti pri popunjenim podatcima.</p><br />
        </div>
                ...
                <form action="" method="get">
                    ...
                    <td>
                        <select name="igra" rel="csx" onchange="this.form.submit()">
                            <option value="0" selected="selected" disabled>Izaberite...</option>
                            <option value="1" <?php if($_GET['igra'] == "1") echo'disabled selected="selected"'; ?>>Counter-Strike 1.6</option>
                            <option value="2" <?php if($_GET['igra'] == "2") echo'disabled selected="selected"'; ?>>San Andreas Multiplayer</option>
                        </select>
                        <label id="titlex">
            ...
            <tr>
                <td colspan="2"><br />
                    <table id="webftp">
                        <tr>
                            <td>Informacija: </td>
                            <td><z>Ukoliko je cijena servera npr 6km/3€ plaćate 3x šaljete sms,cijena jedne sms je 1€!<br /> Vodite računa pri slanju SMS-a, mi nismo odgovorni ako pogrešno ukucate poruku ili broj.</z></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="background: none;">
                                <script src='https://assets.fortumo.com/fmp/fortumopay.js' type='text/javascript'></script>
<a id="fmp-button" href="#" rel="2ffc9a7bbd18486a15f50aaeaa9778c1"><img src="https://assets.fortumo.com/fmp/fortumopay_150x50_red.png" width="150" height="50" alt="Mobile Payments by Fortumo" border="0" /></a>
                            </td>
                        </tr>
                    </table>
                </td>
