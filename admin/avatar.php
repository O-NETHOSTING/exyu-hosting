...
if($_GET['mode'] == "a")
{
	...
	{
		$image = imagecreatefrompng("https://your-hosting.com/avatari/noavatar.png");
	...
	else
	{
		...
		$imagepath = "https://your-hosting.com/admin/avatari/{$id}.{$ext}";
...
else if($_GET['mode'] == "c")
{
	...
	else
	{
		...
		$imagepath = "https://your-hosting.com/avatari/{$id}.{$ext}";
