...
{
	file_get_contents("https://your-hosting.com/admin/srv-grafik.php?id={$row[id]}&cron=C#3gtQ@");
	file_get_contents("https://your-hosting.com/gp-srvgrafik.php?id={$row[id]}&cron=aX21$%@");
	file_get_contents("https://your-hosting.com/gp-banner.php?id={$row[id]}&cron=6123saxhGASD");
}
