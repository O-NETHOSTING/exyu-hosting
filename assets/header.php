...
<head>
    ...
    <title><?php if(!empty($naslov)) echo $naslov; else echo 'Klijent'; ?> | YOUR Hosting</title>

    <meta name="description" content="Zakupite svoj game server po veoma niskoj ceni sa veoma visokim kvalitetom!">
    <meta name="keywords" content="YOUR, hosting, prodaja, host, cs 1.6, samp, Counter-Strike 1.6, San Andreas Multiplayer, najjeftiniji hosting, game hosting, game serveri, gamepanel" />
                                    ...
                                    <div id="freq<?php echo $row['id']; ?>" style="cursor: default;" <?php if($row['status']==1) echo ' class="unread"'; ?>>
                                        <li>
                                            <table>
                                                <tr valign="top">
                                                    <td width="55">
                                                        <img style="margin: -8px;" width="55" height="55" src="https://your-hosting.com/avatar.php?mode=c&id=<?php echo $row['user_one']; ?>" />
                                                    </td>
                                                    <td>
...
?>
    ...
    ?>
                        <a href="https://your-hosting.com/<?php echo "{$fajlxx}?{$_SERVER['QUERY_STRING']}"; ?>&jezik=en">
    ...
    <?php
                        ...
                        <a href="https://your-hosting.com/<?php echo "{$fajlxx}?{$_SERVER['QUERY_STRING']}"; ?>&jezik=sr">
...
?>
                    ...
                    <li>
					    <a href="/klijent/">
                        <i class="icon-comment"></i> <?php echo "WHMCS"; ?>
                        </a>
                    </li>
...
s1.async=true;
s1.src='https://embed.tawk.to/58053bd3a4209520468b2a05/default';
s1.charset='UTF-8';
