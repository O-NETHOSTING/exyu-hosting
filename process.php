...
switch (@$task)
{
	...
	case 'tiketodg':
		...
		$lporuka = $jezik['text56'].' ID #<a href="'.$link.'"><z>'.$tiketid.'</z></a>';
		klijent_log($infok['klijentid'], $lporuka, $infok['ime'].' '.$infok['prezime'], fuckcloudflare(), time());		
...
$_SESSION['msg'] = "Zabranjen edit avatara!";
	die();
		...
		$site_link = "https://your-hosting.com/";
	...
	case 'bugreport':
		...
		if($vrsta == "1") $tekst = "Link: https://your-hosting.com{$url}<br />";
...
if($_SESSION['sigkod'] == "0")
	...
	case 'contact':
		...
		$text = nl2br(htmlspecialchars($text));
		$url = sqli($_POST['url']);
		$url = "https://your-hosting.com{$url}";
