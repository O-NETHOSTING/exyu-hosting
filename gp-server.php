		...
		<tr>
			<td>
				...
				<div id="infos">
					...
					<p id="h2"><i class="icon-bar-chart"></i> <?php echo $jezik['text386']; ?>: <a target="_BLANK" href="https://your-hosting.com/grafik/blue/<?php echo $boxip['ip'].'_'.$server['port']; ?>.png"><z style="font-size: 9px;">https://your-hosting.com/grafik/blue/<?php echo $boxip['ip'].'_'.$server['port']; ?>.png</z></a></p>
				</div>							
			</td>
...
?>				
		...
		<?php 	if($server['igra'] == "1" OR $server['igra'] == "2" OR $server['igra'] == "3") { ?>
				<div id="infod" style="padding-bottom: 5px;">
					...
					<p id="h2"><i class="icon-bar-chart"></i> <?php echo $jezik['text386']; ?>: <a target="_BLANK" href="https://your-hosting.com/banner/<?php echo $boxip['ip'].':'.$server['port']; ?>"><z style="font-size: 9px;">https://your-hosting.com/banner/<?php echo $boxip['ip'].':'.$server['port']; ?></z></a></p>
				</div><?php } ?><br />
